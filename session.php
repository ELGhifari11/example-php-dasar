    ...
    <div class="container">
        ...
        <div class="table-container">
            ...
            if (!empty($_SESSION['barang'])) {
                ...
                echo "<table>";
                echo "<tr><th>Nama Barang</th><th>Kategori</th><th>Harga</th><th>Stok</th><th>Total Harga</th></tr>";

                foreach ($_SESSION['barang'] as $item) {
                    $totalHargaPerBarang = $item['harga'] * $item['stok'];
                    $totalKeseluruhanHarga += $totalHargaPerBarang;

                    echo "<tr>";
                    echo "<td>" . $item['nama_barang'] . "</td>";
                    echo "<td>" . $item['kategori'] . "</td>";
                    echo "<td>Rp. " . number_format($item['harga'], 0, ',', '.') . "</td>"; // Format harga
                    echo "<td>" . $item['stok'] . "</td>";
                    echo "<td>Rp. " . number_format($totalHargaPerBarang, 0, ',', '.') . "</td>"; // Format total harga per barang
                    echo "</tr>";
                }
                ...
                echo "<td>Rp. " . number_format($totalKeseluruhanHarga, 0, ',', '.') . "</td>"; // Format total keseluruhan harga
                echo "</tr>";
